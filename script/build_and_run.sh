...
echo "🔨 Building macOS Dock Folders 3.0"
echo "───────────────────────────────────────────"
...
echo "⚙ Compiling DockFolderRuntime 3.0..."
swiftc -O -o "$BUILD_DIR/DockFolderRuntime" "$SCRIPT_DIR/DockFolders/Runtime/DockFolderRuntime.swift" "$SCRIPT_DIR/DockFolders/Runtime/GridLauncherView.swift" "$SCRIPT_DIR/DockFolders/Runtime/GridLauncherWindow.swift" "$SCRIPT_DIR/DockFolders/Models/LauncherItem.swift"

# Also cache inside src/ for CLI compatibility
cp "$BUILD_DIR/DockFolderRuntime" "$SCRIPT_DIR/src/DockFolderRuntime"

# 3. Compile Dock Folders Manager App Binary
...
swiftc -O -o "$BUILD_DIR/DockFoldersManager" "${SWIFT_SOURCES[@]}"
